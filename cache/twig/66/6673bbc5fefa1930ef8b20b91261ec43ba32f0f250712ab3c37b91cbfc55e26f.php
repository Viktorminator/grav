...
class __TwigTemplate_c2fdaaa6d388b788dab848199e225f854059d1937f83e3ccf64d2006445969ed extends Twig_Template
{
...
<div class=\"gpm-item-info\">
    ...
    <table>
        ...
        if ($this->getAttribute((isset($context["theme"]) ? $context["theme"] : null), "version", array())) {
            ...
            <td>";
            // line 26
            echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.VERSION"), "html", null, true);
            echo ":</td>
            <td class=\"double\">";
            // line 27
...
";
    ...
    ";
        ...
        <a class=\"button\" href=\"#\" data-remodal-target=\"remove-package\"><i class=\"fa fa-fw fa-warning\"></i> ";
                // line 101
                echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.REMOVE_THEME"), "html", null, true);
                echo "</a>
    </div>
    ";
            }
        ...
        <a class=\"button\" href=\"#\" data-remodal-target=\"add-package\" data-packages-slugs=\"";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.INSTALL_THEME"), "html", null, true);
            echo "</a>
    </div>
";
        }
