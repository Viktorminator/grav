...
return [
    ...
    'timestamp' => 1472717413,
    'checksum' => '99c74ce017212cbf8323e4af7235e1cf',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/metrika' => [
                'file' => 'user/plugins/metrika/blueprints.yaml',
                'modified' => 1471852796
            ],
    ...
    'data' => [
        'items' => [
            ...
            'plugins.metrika.enabled' => [
                ...
                'name' => 'plugins.metrika.enabled',
                'validation' => 'strict'
            ],
            'plugins.metrika.hash' => [
                'type' => 'toggle',
                'label' => 'Adress Hash',
                'hightlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.metrika.hash',
                'validation' => 'strict'
            ],
            'plugins.metrika.webvisor' => [
                'type' => 'toggle',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'metrika' => [
                    'enabled' => 'plugins.metrika.enabled',
                    'hash' => 'plugins.metrika.hash',
                    'webvisor' => 'plugins.metrika.webvisor',
                    'id' => 'plugins.metrika.id'
                ],
                'markdown-notices' => [
